...
ORACLEDIR=data/graphmp-swaparc-ptrlast_o8.3_act-states
...
EMB_FOLDER=$ROOTDIR/$EMBDIR/bert_large_top24     # pre-stored pretrained en embeddings (not changing with oracle)
...
PRETRAINED_EMBED=bert-large-cased
