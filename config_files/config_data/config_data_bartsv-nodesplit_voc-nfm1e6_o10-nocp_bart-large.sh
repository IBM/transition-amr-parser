...
NODE_FREQ_MIN=1000000

ORACLEDIR=data/bartsv-nodesplit_o10-nocp_act-states
EMBDIR=data/en_embeddings

ORACLE_FOLDER=$ROOTDIR/$ORACLEDIR/oracle            # oracle actions, etc.
DATA_FOLDER=$ROOTDIR/$ORACLEDIR/voc-nfm1e6_processed           # preprocessed actions states information, etc.
