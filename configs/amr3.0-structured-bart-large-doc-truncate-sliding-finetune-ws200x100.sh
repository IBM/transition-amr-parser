...
config_name=amr3.0-structured-bart-large-doc-truncate-sliding-doc+sen_top5finetune_ws200x100
...
PRETRAINED_FOLDER="DATA/AMR3.0/models/pretrained_doc+sen/"
...
ORACLE_TAG=o10_act-states_doc_MODE-${MODE}_v0.2_truncate_sliding_ws200x100
...
embedding_tag=${align_tag}_bart.large_doc_MODE-${MODE}_v0.2_truncate_sliding_ws200x100
...
features_tag=${align_tag}_${ORACLE_TAG}_${embedding_tag}_finetune/
