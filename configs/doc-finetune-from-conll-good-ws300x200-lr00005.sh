...
config_name=doc-finetune-from-conll-good-ws300x200-lr00005.sh
...
ORACLE_TAG=o10_act-states_doc_MODE-${MODE}_conll_good_truncate_sliding_ws300x200
...
embedding_tag=${align_tag}_bart.large_doc_MODE-${MODE}_finetune_conll_good_sliding_ws300x200
