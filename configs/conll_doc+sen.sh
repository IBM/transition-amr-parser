...
config_name=conll_doc+sen-truncate
...
TRAIN_DOC="conll"
CONLL_DATA=conll_docamr_no-merge-pairwise-edges.out
...
ORACLE_TAG=o10_act-states_doc_MODE-${MODE}_conll_truncate
...
embedding_tag=${align_tag}_bart.large_doc_MODE-${MODE}_conll_truncate
