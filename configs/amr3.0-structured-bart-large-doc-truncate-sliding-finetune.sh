...
config_name=amr3.0-structured-bart-large-doc-truncate-sliding-doc+sen_top5finetune
...
ORACLE_TAG=o10_act-states_doc_MODE-${MODE}_v0.2_truncate_sliding
...
embedding_tag=${align_tag}_bart.large_doc_MODE-${MODE}_v0.2_truncate_sliding
