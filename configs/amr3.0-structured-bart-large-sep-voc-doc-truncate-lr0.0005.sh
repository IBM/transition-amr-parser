...
ORACLE_TAG=bartsv-nodesplit_o10_act-states_doc_MODE-${MODE}_v0.2_trunc_correct_900
...
embedding_tag=bart.large_doc_MODE-${MODE}_v0.2_trunc_correct_900
...
# All data in this step under
MODEL_FOLDER=DATA/$TASK_TAG/models/${model_tag}_${optim_tag}/ep${MAX_EPOCH}_lr0.0005
