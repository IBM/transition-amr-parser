...
config_name=wiki25-structured-bart-base-neur-al-mini
MODE="sen"
DOC_ORACLE_ARGS=""
##############################################################################
# DATA
...
arch=transformer_tgt_pointer_apt2_mini

initialize_with_bart=0
initialize_with_bart_enc=0
initialize_with_bart_dec=0
...
tgt_src_align_layers="0"
tgt_src_align_heads=0
