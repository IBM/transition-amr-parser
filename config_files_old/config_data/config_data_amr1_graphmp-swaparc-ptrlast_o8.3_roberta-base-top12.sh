...
ORACLEDIR=data_amr1/graphmp-swaparc-ptrlast_o8.3_act-states
...
EMB_FOLDER=$ROOTDIR/$EMBDIR/roberta_base_top12     # pre-stored pretrained en embeddings (not changing with oracle)
