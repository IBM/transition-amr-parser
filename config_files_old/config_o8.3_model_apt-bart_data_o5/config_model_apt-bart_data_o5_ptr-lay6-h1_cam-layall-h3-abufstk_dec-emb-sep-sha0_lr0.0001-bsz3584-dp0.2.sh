...
tgt_src_align_heads=3
tgt_src_align_focus="p0c1n0 p0c0n* p*c0n0"
...
elif [[ $tgt_src_align_focus == "p0c1n0 p0c0n* p0c1n0 p0c0n*" ]]; then
    cam_focus=-a2buf2
elif [[ $tgt_src_align_focus == "p0c1n0 p0c0n* p0c1n0 p0c0n* p0c1n0 p0c0n*" ]]; then
    cam_focus=-a3buf3
elif [[ $tgt_src_align_focus == "p0c1n0 p0c0n* p*c0n0" ]]; then
    cam_focus=-abufstk    # alignment and "buffer" and "stack"
fi
