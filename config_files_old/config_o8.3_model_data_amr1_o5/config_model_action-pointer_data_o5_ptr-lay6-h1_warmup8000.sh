...
##### load data config
config_data=config_files/config_data/config_data_amr1_o8.3_roberta-large-top24.sh
...
MODEL_FOLDER=$ROOTDIR/$expdir/models_ep${max_epoch}_warmup${warmup}_seed${seed}
