...
##### load data config
config_data=config_files/config_data/config_data_o8.3_roberta-base-top12-wp.sh
...
expdir=${expdir}${ptr_tag}${cam_tag}${tis_tag}${dec_emb_tag}${dec_emb_in_tag}${dec_emb_init_tag}${init_tag}${enc_fix_tag}${emb_fix_tag}${enc_pool_tag}
