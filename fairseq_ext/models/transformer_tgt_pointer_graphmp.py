...
@register_model('transformer_tgt_pointer_graphmp')
class TransformerTgtPointerGraphMPModel(FairseqEncoderDecoderModel):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--tgt-graph-mask', type=str, choices=['1prev', 'allprev', '1prev_in', 'allprev_in',
                                                                   '1prev_1in1out', 'allprev_1in1out'],
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out, memory=None, memory_pos=None,
                ...
                # graph structure
                tgt_actedge_masks=None, tgt_actedge_1stnode_masks=None,
                tgt_actedge_indexes=None, tgt_actedge_cur_node_indexes=None, tgt_actedge_cur_1stnode_indexes=None,
                tgt_actedge_pre_node_indexes=None, tgt_actedge_directions=None,
                # graph structure for connecting with all previous nodes
                tgt_actedge_allpre_indexes=None, tgt_actedge_allpre_pre_node_indexes=None,
        ...
        graph_self_attn_mask = get_graph_self_attn_mask(
...
@register_model_architecture('transformer_tgt_pointer_graphmp', 'transformer_tgt_pointer_graphmp')
