...
class MultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        need_head_weights: bool = False,    # bypass this flag
        # customized for masking
        ...
        if ptr_self_attn_mask is not None:
            ...
            # attn_probs[:ptr_self_attn_mask[1].size(0)] *= ptr_self_attn_mask[1]
            # attn_probs[:ptr_self_attn_mask[1].size(0)] = \
            #     attn_probs[:ptr_self_attn_mask[1].size(0)] * ptr_self_attn_mask[1]    # this doesn't work either
        ...
        if need_weights:
            # we return the attention weights all the time
