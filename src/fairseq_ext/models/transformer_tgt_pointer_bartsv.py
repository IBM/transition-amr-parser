...
@register_model("transformer_tgt_pointer_bartsv")
class TransformerTgtPointerBARTSVModel(FairseqEncoderDecoderModel):
    """
...
@register_model_architecture("transformer_tgt_pointer_bartsv", "transformer_tgt_pointer_bartsv_large")
...
@register_model_architecture("transformer_tgt_pointer_bartsv", "transformer_tgt_pointer_bartsv_base")
