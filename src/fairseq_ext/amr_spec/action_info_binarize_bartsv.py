...
class ActionStatesBinarizer:
    def __init__(self, actions_dict, machine_config_file):
        self.actions_dict = actions_dict
        self.machine_config_file = machine_config_file
        self.machine = AMRStateMachineSubtoken.from_config(machine_config_file)
    ...
    def binarize(self, en_file, actions_file, machine_config_file, consumer, tokenize=tokenize_line_tab,
...
def binarize_actstates_tofile(en_file, actions_file, machine_config_file, out_file_pref,
                              actions_dict=None,
                              impl='mmap',
                              tokenize=tokenize_line_tab,
    ...
    if action_state_binarizer is None:
        ...
        action_state_binarizer = ActionStatesBinarizer(actions_dict, machine_config_file)
    res = action_state_binarizer.binarize(en_file, actions_file, machine_config_file, consumer, tokenize=tokenize,
...
def binarize_actstates_tofile_workers(en_file, actions_file, machine_config_file, out_file_pref,
                                      actions_dict=None,
                                      action_state_binarizer=None,
                                      impl='mmap',
                                      tokenize=tokenize_line_tab,
    ...
    merge_result(
        action_state_binarizer.binarize(en_file, actions_file, machine_config_file, consumer, tokenize=tokenize,
