...
from neural_parser.fairseq_ext.data.amr_action_pointer_dataset import AMRActionPointerDataset
...
@ register_task('amr_action_pointer_bart')
class AMRActionPointerBARTParsingTask(FairseqTask):
    """
