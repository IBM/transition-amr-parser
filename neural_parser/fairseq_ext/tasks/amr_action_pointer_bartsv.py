...
from neural_parser.fairseq_ext.data.amr_action_pointer_bartsv_dataset import AMRActionPointerBARTSVDataset as AMRActionPointerDataset
from neural_parser.fairseq_ext.data.data_utils import load_indexed_dataset
from neural_parser.fairseq_ext.amr_spec.action_info_binarize_bartsv import (
...
from neural_parser.fairseq_ext.data.amr_bpe import AMRActionBartDictionary
...
@ register_task('amr_action_pointer_bartsv')
class AMRActionPointerBARTSVParsingTask(FairseqTask):
    """
    ...
    @staticmethod
    def build_dictionary_bart_extend(node_freq_min=5, node_file_path=None, others_file_path=None):
        d = AMRActionBartDictionary(node_freq_min=node_freq_min,
    ...
    def build_generator(self, args, model_args):
        if getattr(args, 'score_reference', False):
            ...
            if 'bartsv' in model_args.arch:
                from fairseq_ext.sequence_generator_bartsv import SequenceGenerator
