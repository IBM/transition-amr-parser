...
# import neural_parser.fairseq_ext as fairseq_ext

from neural_parser.fairseq_ext import options
from neural_parser.fairseq_ext.extract_bart.sentence_encoding import SentenceEncodingBART
from neural_parser.fairseq_ext.extract_bart.binarize_encodings import get_scatter_indices
from neural_parser.fairseq_ext.data.amr_action_pointer_dataset import collate
from neural_parser.transition_amr_parser.io import (
    read_tokenized_sentences, read_amr, read_config_variables
)
from neural_parser.fairseq_ext.utils import (
...
from neural_parser.transition_amr_parser.amr import normalize, protected_tokenizer

from neural_parser.transition_amr_parser.make_sliding_splits import (
    adjust_sentence_ends,
    get_windows
)
from neural_parser.transition_amr_parser.force_overlap_actions import force_overlap
from neural_parser.transition_amr_parser.merge_sliding_splits import (
    merge_actions,
    check_pointers
)
from neural_parser.transition_amr_parser.amr_machine import play_all_actions
