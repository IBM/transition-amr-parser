...
from neural_parser.fairseq_ext import options    # this is key to recognizing the customized arguments
from neural_parser.fairseq_ext.roberta.pretrained_embeddings import PretrainedEmbeddings
...
from neural_parser.fairseq_ext.utils import post_process_action_pointer_prediction, clean_pointer_arcs
from neural_parser.transition_amr_parser.amr_state_machine import AMRStateMachine, get_spacy_lemmatizer
from neural_parser.transition_amr_parser.amr import InvalidAMRError, get_duplicate_edges
from neural_parser.transition_amr_parser.utils import yellow_font
from neural_parser.transition_amr_parser.io import read_config_variables, read_tokenized_sentences
