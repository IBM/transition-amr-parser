...
pretrained="/dccstor/ysuklee1/AMR/CodeBase/transition-amr-parser/fairseq/checkpoints/stack_transformer_6x6_nopos-qaldlarge_prepro_o3+Word100-stnp6x6-seed42/checkpoint89.pt
    $features_folder
