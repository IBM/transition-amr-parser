...
pointer_dist_decoder_selfattn_layers="3"
pointer_dist_decoder_selfattn_heads=1
pointer_dist_decoder_selfattn_avg=0
pointer_dist_decoder_selfattn_infer=3
...
if [[ $pointer_dist_decoder_selfattn_layers == "0 1 2 3 4 5" ]]; then
    ...
    lay="6"
elif [[ $pointer_dist_decoder_selfattn_layers == "4" ]]; then
    lay="5"
elif [[ $pointer_dist_decoder_selfattn_layers == "3" ]]; then
    lay="4"
else
