...
expdir=exp_${data_tag}_act-pos_vmask${tgt_vocab_masks}_shiftpos${shift_pointer_value}_cattnmask-layer${tgt_src_align_layer}-head${tgt_src_align_head}-focus${tgt_src_align_focus}    # action-pointer
