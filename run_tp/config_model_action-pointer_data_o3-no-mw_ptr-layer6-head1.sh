...
##### load data config
config_data=config_data_o3_no-mw_roberta-large-top24.sh
...
expdir=exp_${data_tag}_act-pos_vmask${tgt_vocab_masks}_shiftpos${shift_pointer_value}_cam-layer${cam_lay}-head${tgt_src_align_heads}-focus${focus_name}_ptr-layer${lay}-head${pointer_dist_decoder_selfattn_heads}    # action-pointer
